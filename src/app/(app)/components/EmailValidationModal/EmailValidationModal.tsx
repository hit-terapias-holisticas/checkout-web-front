  ...
  return (
    <Dialog open={isOpen} onOpenChange={onOpenChange}>
      <DialogContent className="w-full max-w-xl md:max-w-2xl px-6 py-10 sm:px-12 sm:py-14 rounded-3xl">
        <DialogHeader className="flex flex-col items-center text-center pb-8">
          <Image
          ...
          />
          <DialogTitle className="text-3xl md:text-4xl font-bold text-blue-950 leading-tight pb-3">
            Insira seu e-mail e inicie sua assinatura
          </DialogTitle>
          <DialogDescription className="text-base md:text-lg font-bold text-gray-500">
